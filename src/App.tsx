...
export default function App() {
  ...
  const [webAppUrl, setWebAppUrl] = useState("https://script.google.com/macros/s/AKfycbxIUsxwGMtHwIOlzE4IfJN4mGL_qTssCco990o4hTffT951II8anr6p8h5NYaRwe17pQw/exec");
  ...
  const fetchConfig = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setWebAppUrl(data.webAppUrl || "https://script.google.com/macros/s/AKfycbxIUsxwGMtHwIOlzE4IfJN4mGL_qTssCco990o4hTffT951II8anr6p8h5NYaRwe17pQw/exec");
    ...
    const localWebApp = localStorage.getItem("webAppUrl") || "https://script.google.com/macros/s/AKfycbxIUsxwGMtHwIOlzE4IfJN4mGL_qTssCco990o4hTffT951II8anr6p8h5NYaRwe17pQw/exec";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col antialiased selection:bg-[#6f2c91]/20 pb-12">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        {/* CONFIGURATION PANEL REMOVED FOR SECURITY */}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="أدخل الرقم القومي للطالب كاملاً (مثال: 11111111111111)"
      ...
      <footer className="mt-auto bg-white border-t border-slate-200 py-5 px-4 md:px-12 text-slate-400 text-xs no-print text-center font-medium">
        <div className="max-w-7xl mx-auto">
          <p>© {new Date().getFullYear()} مدرسة WE للتكنولوجيا التطبيقية. جميع الحقوق محفوظة.</p>
        </div>
      </footer>
    </div>
  );
